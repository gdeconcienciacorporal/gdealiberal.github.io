document.addEventListener("DOMContentLoaded", function () {
  ...
  const dataLine1 = {
    ...
    datasets: [{
      ...
      data: [13, 8, 19, 12, 24, 13], // Datos de los km recorridos en cada día
      label: 'Km recorridos en Semana 5',
      data: [15, 15, 18, 9, 12], // Datos de los km recorridos en cada día
  ...
  const dataLine2 = {
    ...
    datasets: [{
      ...
      data: [10, 19, 13, 18, 13, 10], // Datos de los km recorridos en cada día
      label: 'Km recorridos en Semana 6',
      data: [6, 13, 12, 20, 17], // Datos de los km recorridos en cada día
